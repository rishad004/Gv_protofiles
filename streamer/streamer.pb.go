...
func (x *StreamKeyRequest) GetStreamkey() string {
	if x != nil {
		return x.Streamkey
	}
	return ""
...
func (x *StreamKeyResponse) GetChannel() string {
	if x != nil {
		return x.Channel
	}
	return ""
...
var file_streamer_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x30, 0x0a, 0x10, 0x53, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a,
	0x09, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x6b, 0x65, 0x79, 0x22, 0x2d, 0x0a, 0x11, 0x53,
	...
	0x09, 0x52, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x32, 0x84, 0x04, 0x0a, 0x0f, 0x53,
	...
	0x74, 0x2d, 0x67, 0x76, 0x2f, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x65, 0x72, 0x2d, 0x73, 0x65,
...
var file_streamer_proto_depIdxs = []int32{
	...
	1,  // 8: streamer.StreamerService.Registration:output_type -> streamer.RegistrationResponse
	3,  // 9: streamer.StreamerService.ChannelView:output_type -> streamer.ChannelResponse
	5,  // 10: streamer.StreamerService.EditChannel:output_type -> streamer.EditResponse
	7,  // 11: streamer.StreamerService.SubscriptionSet:output_type -> streamer.SubscriptionResponse
	8,  // 12: streamer.StreamerService.SubscriptionCheck:output_type -> streamer.CheckingResponse
	11, // 13: streamer.StreamerService.SubscriptionList:output_type -> streamer.ListResponse
	13, // 14: streamer.StreamerService.FindByStreamKey:output_type -> streamer.StreamKeyResponse
