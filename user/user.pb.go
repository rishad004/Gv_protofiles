...
var file_user_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xf5, 0x04, 0x0a, 0x0b, 0x55,
	...
	0x2f, 0x72, 0x69, 0x73, 0x68, 0x61, 0x64, 0x30, 0x30, 0x34, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x2d, 0x67, 0x76, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69,
...
var file_user_proto_depIdxs = []int32{
	...
	2,  // 11: user.UserService.SignUp:output_type -> user.SignUpResponse
	4,  // 12: user.UserService.EmailVerification:output_type -> user.VerificationResponse
	6,  // 13: user.UserService.Login:output_type -> user.LoginResponse
	9,  // 14: user.UserService.Profile:output_type -> user.ProfileResponse
	10, // 15: user.UserService.ProfileEditing:output_type -> user.EditResponse
	12, // 16: user.UserService.Subscribing:output_type -> user.SubscribeResponse
	4,  // 17: user.UserService.Subscribed:output_type -> user.VerificationResponse
	14, // 18: user.UserService.Following:output_type -> user.Empty
	12, // 19: user.UserService.WalletAdd:output_type -> user.SubscribeResponse
	14, // 20: user.UserService.WalletAdded:output_type -> user.Empty
	14, // 21: user.UserService.SuperChat:output_type -> user.Empty
